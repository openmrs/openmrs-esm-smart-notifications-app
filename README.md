# @openmrs/esm-smart-notifications-app

smart-notifications-app frontend module for O3
...
**http://localhost:8080/openmrs/spa/smart-notifications-app**
...
\`\`\`bash
yarn add @openmrs/esm-smart-notifications-app
\`\`\`
